...
import { updateProfilePhotoAction } from "../../../redux/slices/users/usersSlices";
...
const UploadProfilePhoto = () => {
  ...
  const { isUpdatedPhoto, loading, appErr, serverErr, userAuth } = users;
  //redirect
  if (isUpdatedPhoto) return <Redirect to={`/profile/${userAuth?._id}`} />;
  return (
