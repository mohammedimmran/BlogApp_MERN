...
const HomePage = () => {
    return (
        <> 
        <div className = "relative bg-white overflow-hidden" style = {{height:"100vh"}} > <div className="max-w-7xl mx-auto">
            <div
                ...
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12">
                    <div className="sm:text-center lg:text-left">
                        <h1
                            ...
                            <span className="block xl:inline">BLOGAPP
                                <br></br>
                            </span>{' '}
                            <span className="block text-indigo-600 xl:inline">
                                A MERN STACK BLOG APPLICATION</span>
                        </h1>
                        <p
